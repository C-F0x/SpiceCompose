...
class DampedDragAnimation(
    ...
    private fun updateVelocity() {
        ...
        val targetVel = velocityTracker.calculateVelocity().x / (valueRange.endInclusive - valueRange.start)
        animationScope.launch { velocityAnimation.animateTo(targetVel, velocityAnimationSpec) }
    }
}
